...
// import 'package:daily_task/app/features/dashboard/views/screens/file_manage_screen.dart';
    ...
    return Scaffold(
      ...
      drawer: ResponsiveBuilder.isDesktop(context)
          ...
          : Drawer(
              child: SafeArea(
                child:
                    SingleChildScrollView(child: _buildSidebarmobile(context)),
              ),
            ),
      body: SafeArea(
