...
class ImageRasterPath {
  ...
  static const wavingHandEmoji = "$_folderPath/waving-hand-emoji.png";
  static const logo = "$_folderPath/logo.png";
  static const youtube = "$_folderPath/youtube.png";
  static const boxCoins = "$_folderPath/box_coins.png";
  static const megaphone = "$_folderPath/megaphone.png";
  static const rocket = "$_folderPath/rocket.png";
...
class ImageVectorPath {
  ...
  static const folder = "$_folderPath/folder.svg";
}
